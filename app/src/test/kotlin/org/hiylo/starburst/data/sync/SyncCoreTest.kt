...
import org.hiylo.starburst.data.repository.migrateSingleBackendSyncConfig
import org.hiylo.starburst.data.repository.requireSingleSyncStorage
import org.hiylo.starburst.data.repository.remapServerScopedKey
...
class SyncCoreTest {
    ...
    fun legacySingleBackendBecomesPrimaryWithoutEnablingOtherStorage() {
        ...
        val webDav = migrateSingleBackendSyncConfig(
            ...
            endpoint = "https://dav.example/StarBurst.json",
            username = "user",
            autoSync = false,
    ...
    fun syncConfigurationRejectsTwoEnabledStorages() {
        val both = SyncConfig(
            ...
            webDav = SyncTargetConfig(enabled = true, endpoint = "https://dav.example/StarBurst.json"),
        )
