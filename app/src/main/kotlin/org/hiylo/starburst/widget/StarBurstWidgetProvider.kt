 ...
 * Project : StarBurst
 * File : StarBurstWidgetProvider.kt
 ...
 * @since V1.3.0
 */
class StarBurstWidgetProvider : AppWidgetProvider() {
    ...
    private fun buildRemoteViews(context: Context, snapshot: WidgetSnapshot): RemoteViews {
        val views = RemoteViews(context.packageName, R.layout.widget_starburst)
    ...
    companion object {
        ...
        /** Widget 传递的服务器/会话参数 key（与 StarBurstConnectionService 保持一致）。 */
