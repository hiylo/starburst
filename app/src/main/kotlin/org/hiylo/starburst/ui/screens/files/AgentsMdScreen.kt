            ...
            when {
                ...
                state.draft.isNotBlank() -> {
                    EditorPane(
                        ...
                        onModify = viewModel::modifyWithInstruction,
                    )
                }
                state.exists == false -> {
                    EmptyPane(
...
private fun GeneratingIndicator() {
    ...
    Column(horizontalAlignment = Alignment.CenterHorizontally) {
        ...
        Text(
            text = stringResource(R.string.agents_md_generating),
        ...
        Row(
            ...
            if (isGenerating) {
                ...
                TextButton(onClick = onEdit) {
                    ...
                    Text(stringResource(R.string.agents_md_edit))
                }
                TextButton(onClick = onGenerate) {
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        Row(
            ...
            OutlinedTextField(
                ...
                placeholder = { Text(stringResource(R.string.agents_md_modify_hint)) },
                modifier = Modifier.weight(1f),
                singleLine = true,
            ...
            IconButton(
                ...
                enabled = instruction.isNotBlank() && !state.isGenerating,
            ) {
                Icon(Icons.Default.Send, contentDescription = stringResource(R.string.agents_md_modify))
            }
        }
