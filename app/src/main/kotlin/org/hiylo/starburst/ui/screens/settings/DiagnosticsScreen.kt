...
fun DiagnosticsScreen(
    ...
    suspend fun exportText(): String = buildString {
        ...
        appendLine("StarBurst diagnostics")
    ...
    fun shareAsFile() {
        scope.launch {
            ...
            val file = withContext(Dispatchers.IO) {
                ...
                File(directory, "starburst-diagnostics-${System.currentTimeMillis()}.txt").apply { writeText(text) }
            }
            ...
            context.startActivity(
                Intent.createChooser(
                    Intent(Intent.ACTION_SEND).apply {
                        ...
                        clipData = ClipData.newRawUri("StarBurst diagnostics", uri)
