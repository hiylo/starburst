...
private const val REPOSITORY_OWNER = "hiylo"
private const val REPOSITORY_NAME = "starburst"
private const val APPLICATION_ID = "org.hiylo.starburst"
...
object UpdatePolicy {
    ...
    private fun expectedApkUrl(versionName: String): String {
        return "https://$REPOSITORY_HOST/$REPOSITORY_OWNER/$REPOSITORY_NAME/releases/download/" +
            "${releaseTag(versionName)}/starburst-$versionName.apk"
    }
