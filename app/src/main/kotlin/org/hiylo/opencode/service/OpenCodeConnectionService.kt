 ...
 * Project : opencode
 * File : OpenCodeConnectionService.kt
 * Date : 2026/09/06 15:42:23
 * Author : Hsi Chu
 * Contact : hiylo@live.com
 * Version : V1.0
 */
package org.hiylo.opencode.service
        ...
        return serviceScope.launch(start = CoroutineStart.LAZY) {
            ...
            while (isActive) {
                ...
                try {
                    ...
                    throw e
                } catch (e: org.hiylo.opencode.data.api.SseAuthException) {
                    ...
                    cleanupTerminatedConnection(server.id, currentJob)
                    break
                } catch (e: org.hiylo.opencode.data.api.SseConnectionException) {
